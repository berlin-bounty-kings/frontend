...
export const HackerBountyList: FC<BountyListProps> = ({ filter, onClaimClick }) => {
        ...
        <div key={index} className="card bg-base-200 shadow-md p-4 mb-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div className="flex-1">
              ...
              <p className="text-sm">Sponsor: {bounty.sponsorName || shortenAddress(bounty.sponsor)}</p>
            </div>
            <div className="flex gap-2 mt-4 sm:mt-0">
              <button className="btn btn-success" onClick={() => onClaimClick(index)}>
                Claim
              </button>
            </div>
          </div>
